...
[MAC_BASE] = LAYOUT_ansi_84(
     ...
     HYPR_T(KC_ESCAPE),  LSFT_T(KC_A),     KC_S,     KC_D,             KC_F,             KC_G,     KC_H,     KC_J,     KC_K,     KC_L,             LSFT_T(KC_SCLN),          KC_QUOT,              KC_ENT,             KC_HOME,
     KC_LSFT,                              KC_Z,     LCTL_T(KC_X),     LALT_T(KC_C),     KC_V,     KC_B,     KC_N,     KC_M,     LALT_T(KC_COMM),  LCTL_T(KC_DOT),           KC_SLSH,              KC_RSFT,  KC_UP,    KC_END,
